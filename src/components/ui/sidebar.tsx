      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{chromeCopy.sidebarSheetTitle}</SheetTitle>
            <SheetDescription>
              {chromeCopy.sidebarSheetDescription}
            </SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{chromeCopy.sidebarToggle}</span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={chromeCopy.sidebarToggle}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={chromeCopy.sidebarToggle}
      className={cn(
